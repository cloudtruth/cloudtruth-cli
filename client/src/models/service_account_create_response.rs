...
impl ServiceAccountCreateResponse {
    pub fn new(url: String, id: String, user: Option<crate::models::User>, created_at: String, modified_at: Option<String>, last_used_at: Option<String>, apikey: String) -> ServiceAccountCreateResponse {
