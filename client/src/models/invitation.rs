...
impl Invitation {
    pub fn new(url: String, id: String, email: String, role: Option<crate::models::RoleEnum>, inviter: String, inviter_name: String, state: String, state_detail: String, membership: Option<String>, organization: String) -> Invitation {
        Invitation {
            url,
            id,
            email,
