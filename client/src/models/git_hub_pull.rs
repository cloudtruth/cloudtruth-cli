...
impl GitHubPull {
    ...
    pub fn new(url: String, id: String, name: String, latest_task: Option<crate::models::GitHubPullTask>, created_at: String, modified_at: Option<String>, mapped_values: Vec<crate::models::ValueCreate>, mode: Option<crate::models::ModeEnum>) -> GitHubPull {
        GitHubPull {
            url,
            id,
            name,
