...
pub struct PatchedAwsIntegration {
    ...
    #[serde(rename = "status_last_checked_at", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "aws_enabled_regions", skip_serializing_if = "Option::is_none")]
    pub aws_enabled_regions: Option<Vec<crate::models::AwsRegionEnum>>,
    /// The AWS services to integrate with.
    #[serde(rename = "aws_enabled_services", skip_serializing_if = "Option::is_none")]
