...
impl Membership {
    pub fn new(url: String, id: String, user: String, organization: String, role: Option<crate::models::RoleEnum>, created_at: String, modified_at: Option<String>) -> Membership {
        Membership {
            url,
            id,
            user,
