...
impl AwsIntegrationCreate {
    pub fn new(aws_account_id: String, aws_enabled_regions: Vec<crate::models::AwsRegionEnum>, aws_enabled_services: Vec<crate::models::AwsServiceEnum>, aws_role_name: String) -> AwsIntegrationCreate {
