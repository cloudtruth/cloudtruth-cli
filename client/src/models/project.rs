...
impl Project {
    pub fn new(url: String, id: String, ledger_id: String, name: String, dependents: Vec<String>, role: Option<crate::models::RoleEnum>, pushes: Vec<crate::models::AwsPush>, push_urls: Vec<String>, created_at: String, modified_at: Option<String>) -> Project {
        Project {
            url,
            id,
            ledger_id,
