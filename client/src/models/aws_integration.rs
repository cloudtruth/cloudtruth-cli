...
impl AwsIntegration {
    pub fn new(url: String, id: String, name: String, status: Option<crate::models::StatusEnum>, status_detail: String, status_last_checked_at: Option<String>, created_at: String, modified_at: Option<String>, fqn: String, _type: String, aws_account_id: String, aws_enabled_regions: Vec<crate::models::AwsRegionEnum>, aws_enabled_services: Vec<crate::models::AwsServiceEnum>, aws_role_name: String) -> AwsIntegration {
        AwsIntegration {
            url,
            id,
            name,
