...
pub struct AuditTrail {
    ...
    pub object_type: Option<Box<crate::models::ObjectTypeEnum>>,
...
impl AuditTrail {
    pub fn new(url: String, id: String, action: String, object_id: String, object_name: String, object_type: Option<crate::models::ObjectTypeEnum>, timestamp: String, user: Option<crate::models::User>) -> AuditTrail {
        AuditTrail {
            url,
            id,
            action,
