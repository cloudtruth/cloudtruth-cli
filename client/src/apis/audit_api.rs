...
pub fn audit_list(configuration: &configuration::Configuration, action: Option<&str>, earliest: Option<String>, environment_id: Option<&str>, latest: Option<String>, object_id: Option<&str>, object_type: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, parameter_id: Option<&str>, project_id: Option<&str>, user_id: Option<&str>) -> Result<crate::models::PaginatedAuditTrailList, Error<AuditListError>> {
    ...
    if let Some(ref local_var_str) = earliest {
        local_var_req_builder = local_var_req_builder.query(&[("earliest", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = parameter_id {
        local_var_req_builder = local_var_req_builder.query(&[("parameter_id", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuditListError> = serde_json::from_str(&local_var_content).ok();
...
pub fn audit_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::AuditTrail, Error<AuditRetrieveError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/audit/{id}/", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuditRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn audit_summary_retrieve(configuration: &configuration::Configuration, ) -> Result<crate::models::AuditTrailSummary, Error<AuditSummaryRetrieveError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/audit/summary/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuditSummaryRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
