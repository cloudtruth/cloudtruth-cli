...
pub fn users_current_retrieve(configuration: &configuration::Configuration, ) -> Result<crate::models::User, Error<UsersCurrentRetrieveError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/users/current/", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UsersCurrentRetrieveError> = serde_json::from_str(&local_var_content).ok();
...
pub fn users_destroy(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<UsersDestroyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UsersDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub fn users_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, _type: Option<&str>) -> Result<crate::models::PaginatedUserList, Error<UsersListError>> {
    let local_var_configuration = configuration;
...
pub fn users_retrieve(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::User, Error<UsersRetrieveError>> {
    let local_var_configuration = configuration;
