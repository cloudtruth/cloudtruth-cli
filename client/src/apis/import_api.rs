...
pub fn import_create(configuration: &configuration::Configuration, import_create_request: crate::models::ImportCreateRequest, mask_secrets: Option<bool>, preview: Option<bool>) -> Result<crate::models::ImportCreateResponse, Error<ImportCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImportCreateError> = serde_json::from_str(&local_var_content).ok();
