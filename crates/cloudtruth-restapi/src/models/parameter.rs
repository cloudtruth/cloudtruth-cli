...
pub struct Parameter {
    ...
    #[serde(rename = "expiration_action", skip_serializing_if = "Option::is_none")]
    pub expiration_action: Option<::std::collections::HashMap<String, serde_json::Value>>,
    /// If this parameter expires, the status of the last attempt to handle its expiration
    #[serde(rename = "expired_status")]
    pub expired_status: Option<::std::collections::HashMap<String, serde_json::Value>>,
}
...
impl Parameter {
    ...
    pub fn new(
        ...
        expired_status: Option<::std::collections::HashMap<String, serde_json::Value>>,
    ) -> Parameter {
        Parameter {
            url,
            id,
