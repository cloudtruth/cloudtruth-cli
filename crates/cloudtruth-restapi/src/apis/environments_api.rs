...
/// struct for typed errors of method [`environments_copy_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EnvironmentsCopyCreateError {
    Status400(),
    Status403(),
...
pub fn environments_copy_create(
    configuration: &configuration::Configuration,
    id: &str,
    environment_copy: crate::models::EnvironmentCopy,
) -> Result<crate::models::Environment, Error<EnvironmentsCopyCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EnvironmentsCopyCreateError> =
