...
pub fn users_partial_update(
    configuration: &configuration::Configuration,
    id: &str,
    patched_update_user: Option<crate::models::PatchedUpdateUser>,
) -> Result<crate::models::UpdateUser, Error<UsersPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_update_user);
...
pub fn users_update(
    configuration: &configuration::Configuration,
    id: &str,
    update_user: crate::models::UpdateUser,
) -> Result<crate::models::UpdateUser, Error<UsersUpdateError>> {
    let local_var_configuration = configuration;
